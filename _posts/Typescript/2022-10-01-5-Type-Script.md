...
그러나 때로는 TypeScript는 충분히 가능한만큼 활용되지 않습니다. 너무 많은 casting이나 any를 사용하는 것은 가장 빈번한 실수들 중 하나입니다.
...
다섯 가지 TypeScript 라이브러리들은 모두 프로젝트를 인체 공학적으로 향상시킬 수 있는 후보입니다. 앞서 언급했듯이 이 들 중 일부는 쉽게 구현할 수 있습니다. 그것은 모두 귀하의 개발 능력과 우선 순위에 달려 있습니다.
