...
2주차엔 비동기 챗앱 개발을 진행하고, 진행한 과제에 대해 검토 받는 시간을 가질 수 있었다. 단지 과제를 진행하는 것으로 끝내는 것이 아니라 직접 시니어 개발자 분께서 코드를 들여다 보시고 어떤 코드는 어떤 문제점이 있고 어떤 잠재적인 문제들이 발생할 수 있는지 꼼꼼히 설명해 주셔서 많은 점들을 생각해 보고 배울 수 있는 좋은 시간이 되었다.

#### Backend.AI 개발 환경 구축

2주차엔 그 외에도 `Backend.ai`의 개발 환경을 구축하며 보냈다. 개발은 필자가 기존에 사용 중이던 m1 맥북 에어로 진행했는데 생각보다 `Backend.ai` 개발 환경 구축에서 어려움을 많이 겪었다.
